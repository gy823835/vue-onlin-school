      ...
      <el-col :span="16">
        ...
        <el-dialog title="新增" :visible.sync="dialogFormVisible" fullscreen>
          ...
          >
            ...
            <el-form-item label="课程介绍" prop="trySee" label-width="100px">
      ...
      >
        <template slot-scope="{ row, $index }">
          <el-button
            type="primary"
            size="mini"
            @click="diaFormVisible = true"
          >
            编辑
          </el-button>
          <el-dialog title="修改" :visible.sync="diaFormVisible" fullscreen>
            <el-form
              style="width: 620px"
              :model="ruleForm"
              :rules="rules"
            ...
            <div slot="footer" class="dialog-footer">
              ...
              <el-button type="primary" @click="diaFormVisible = false"
                >提交</el-button
              >
            </div>
          </el-dialog>
